        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="flex items-center gap-3">
              <h1
                className="text-2xl font-normal text-[#06B6D4] transition-colors duration-300 group-hover:text-[#06B6D4]"
                style={{
              ...
              <span
                className="text-sm text-[#A3A3A3] bg-[#1E1E1E] px-3 py-1 rounded-lg border border-[rgba(6,182,212,0.15)]"
